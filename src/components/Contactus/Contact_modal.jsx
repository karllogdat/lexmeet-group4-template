              ...
              <div>
                ...
                <div className="flex flex-col gap-3.75 text-xs sm:text-sm">
                  ...
                  <div className="flex items-start gap-3.75">
                    ...
                    <div>
                      <h4 className="g4-body text-white font-semibold">Address</h4>
                      <p className="text-slate-300 g4-body leading-snug">
                        123 Kalayaan Avenue, Barangay San Antonio Makati City, 1205 Metro Manila, Philippines
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3.75">
                    ...
                    <div>
                      <h4 className="g4-body text-white font-semibold">Telephone</h4>
                  ...
                  <div className="flex items-start gap-3.75">
                    ...
                    <div>
                      <h4 className="g4-body text-white font-semibold">Email</h4>
                      <p className="text-slate-300 g4-body">Contact@gmail.com</p>
                    </div>
                  </div>
                </div>
              </div>
